...
public class Main {
    public static void main(String[] args) {
        ...
        OrderService orderService = new OrderService(new ArrayList<>(), customerService);
        ...
        // Print customers with names containing the letter 'e'
        System.out.println(customerService.getCustomersWithNameContainingLetter("e"));
        System.out.println("****************************************");
